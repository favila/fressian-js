/**
 * @fileoverview FressianReader.
 */
goog.provide('breeze.fressian.FressianReader');
goog.require('breeze.fressian.Codes');


goog.scope(function() {
var FressianReader = breeze.fressian.FressianReader;
var Codes = breeze.fressian.Codes;
 ...
 * FressianReader
 *
 * @param {breeze.fressian.IByteStreamReader} is from which to read
 * @constructor
 */
FressianReader = function(is) {
  this._is = is;
};


/**
 * @type {breeze.fressian.IByteStreamReader}
 * @protected
 */
FressianReader.prototype._is;
 ...
 * @protected
 */
FressianReader.prototype.read = function(code) {
  // TODO: port this from java
  switch (code) {
    //INT_PACKED_1_FIRST
    case 0xFF:
      result = -1;
    ...
    case 0x5E:
    case 0x5F:
      result = ((code - Codes.INT_PACKED_2_ZERO) << 8) | this._is.readRawInt8();
      break;
    ...
    case 0x6E:
    case 0x6F:
      result = ((code - Codes.INT_PACKED_3_ZERO) << 16) | is.readRawInt16();
      break;
    ...
    case 0x72:
    case 0x73:
      result = ((code - Codes.INT_PACKED_4_ZERO << 24)) | is.readRawInt24();
      break;
    ...
    case 0x76:
    case 0x77:
      result = ((code - Codes.INT_PACKED_5_ZERO) << 32) | is.readRawInt32();
      break;
    ...
    case 0x7A:
    case 0x7B:
      result = ((code - Codes.INT_PACKED_6_ZERO) << 40) | is.readRawInt40();
      break;
    ...
    case 0x7E:
    case 0x7F:
      result = ((code - Codes.INT_PACKED_7_ZERO) << 48) | is.readRawInt48();
      break;
    ...
    case Codes.PRIORITY_CACHE_PACKED_START + 31:
      result = lookupCache(getPriorityCache(),
          code - Codes.PRIORITY_CACHE_PACKED_START);
      break;
    ...
    case Codes.STRUCT_CACHE_PACKED_START + 15:
      var st = lookupCache(getStructCache(),
          code - Codes.STRUCT_CACHE_PACKED_START);
